PROMPTS_P3 = [
    {
        "order": 66, "key": "meta_description", "name": "Generowanie Meta Description", "stage_group": "seo", "output_type": "text", "max_tokens": 4000,
        "sys": """# Rola
...
Czy tekst jest dynamiczny? Czy ma CTA? Czy ma około 150 znaków?""",
    ...
    {
        "order": 85, "key": "faq", "name": "Generowanie FAQ", "stage_group": "seo", "output_type": "html", "max_tokens": 4000,
        "sys": """# Rola
...
Wyłącznie kod HTML.""",
    ...
    {
        "order": 90, "key": "seo_qa", "name": "Ocena jakości SEO", "stage_group": "seo", "output_type": "json", "max_tokens": 4000,
        "sys": """# Rola
...
Oczekiwany JSON:
{
  ...
  "recommendations": ["..."]
    ...
    {
        "order": 100, "key": "attractiveness_qa", "name": "Ocena atrakcyjności tekstu", "stage_group": "attractiveness", "output_type": "json", "max_tokens": 4000,
        "sys": """# Rola
